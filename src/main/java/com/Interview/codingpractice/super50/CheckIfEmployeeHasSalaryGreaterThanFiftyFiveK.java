...
public class CheckIfEmployeeHasSalaryGreaterThanFiftyFiveK {
    public static void main(String[] args) {
        ...
        boolean isGreaterSalary = employeeList.stream().anyMatch(i->i.getSalary() >75000);
        System.out.println(isGreaterSalary);
    }
}
