...
public class FindNameOfTopTwoHighestPaidEmployees {
    public static void main(String[] args) {
        ...
        List<String> topTwoEmployee = employeeList.stream()
                .sorted(Comparator.comparingDouble(Employee ::getSalary).reversed())
                .limit(2).map(Employee::getName).toList();

        System.out.println(topTwoEmployee);
    }
}
